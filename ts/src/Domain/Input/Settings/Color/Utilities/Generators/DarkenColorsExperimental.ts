...
export class DarkenColorsExperimental extends GeneratorAbstract implements GeneratorInterface {
    ...
    public constructor(
        ...
        private readonly min: number = DarkenColorsExperimental.MIN,
        private readonly max: number = DarkenColorsExperimental.MAX,
        private readonly incrementBy: number = DarkenColorsExperimental.INCREMENT_BY,
    ...
    protected invoke(i: number): ColorInterface {
        return this.colorModifier.darken(i);
    }
}
