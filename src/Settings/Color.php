...
final readonly class Color
{
    ...
    #[ThemeSchemaCoverage([Settings::SECTION, self::SECTION, self::TEXT])]
    ...
    #[ThemeSchemaCoverage([Settings::SECTION, self::SECTION, self::BACKGROUND])]
    ...
    #[ThemeSchemaCoverage([Settings::SECTION, self::SECTION, self::LINK])]
    ...
    #[ThemeSchemaCoverage([Settings::SECTION, self::SECTION, self::CUSTOM])]
    ...
    #[ThemeSchemaCoverage([Settings::SECTION, self::SECTION, self::CUSTOM_DUOTONE])]
    ...
    #[ThemeSchemaCoverage([Settings::SECTION, self::SECTION, self::CUSTOM_GRADIENT])]
    ...
    #[ThemeSchemaCoverage([Settings::SECTION, self::SECTION, self::DEFAULT_DUOTONE])]
    ...
    #[ThemeSchemaCoverage([Settings::SECTION, self::SECTION, self::DEFAULT_GRADIENTS])]
    ...
    #[ThemeSchemaCoverage([Settings::SECTION, self::SECTION, self::DEFAULT_PALETTE])]
    ...
    #[ThemeSchemaCoverage([Settings::SECTION, self::SECTION, self::HEADING])]
    ...
    #[ThemeSchemaCoverage([Settings::SECTION, self::SECTION, self::BUTTON])]
    ...
    #[ThemeSchemaCoverage([Settings::SECTION, self::SECTION, self::CAPTION])]
    ...
    #[ThemeSchemaCoverage([Settings::SECTION, self::SECTION, ColorPreset::SECTION])]
    public function addColor(string $slug, string $name, string|CssColorInterface $color): self
    {
        $this->settings->addPreset(new ColorPreset(
            $slug,
            $name,
            \is_string($color) ? new Color\Values\CssColor($color) : $color
        ));
    ...
    public function addColors(iterable $colors): self
    {
        foreach ($colors as $color) {
            if (!$color instanceof ColorPreset) {
    ...
    #[ThemeSchemaCoverage([Settings::SECTION, self::SECTION, Duotone::SECTION])]
    public function addDuotone(string $slug, string $name, ColorPreset ...$colors): self
    {
    ...
    #[ThemeSchemaCoverage([Settings::SECTION, self::SECTION, Gradient::SECTION])]
